...
export default class Tile extends SimObject {
	...
	constructor(x, y, { type = "grass", building = null, direction = 0, level = 0 } = {}) {
		...
		this.grassMesh = grassResource
			? grassMesh
			: new THREE.Mesh(new THREE.BoxGeometry(0.98, 0.2, 0.98), new THREE.MeshStandardMaterial({ color: "#579649" }));
		...
		this.groundMesh = groundResource
			...
			: new THREE.Mesh(new THREE.BoxGeometry(1, 0.2, 1), new THREE.MeshStandardMaterial({ color: "#a89984" }));
